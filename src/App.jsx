...
import { ChevronLeft, ChevronRight, Check, X, RefreshCw, AlertCircle } from 'lucide-react';
...
const QuizApp = () => {
  ...
  return (
    <div className="bg-white shadow-lg rounded-xl p-8 w-full max-w-2xl mx-auto mt-8">
      <h2 className="text-3xl font-bold mb-6 text-center text-blue-600">Question {currentQuestionIndex + 1}</h2>
      ...
      <div className="flex justify-between mt-8">
        ...
        <button
          ...
          className="flex items-center px-6 py-3 bg-blue-500 text-white rounded-full hover:bg-blue-600 transition-colors"
        >
          {currentQuestionIndex === questions.length - 1 ? 'Finish' : 'Next'} <ChevronRight className="ml-2 h-5 w-5" />
        </button>
      </div>
    </div>
  );
